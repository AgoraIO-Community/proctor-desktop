...
echo "-----build------"
cross-env REACT_APP_AGORA_APP_SDK_DOMAIN=$REACT_APP_AGORA_APP_SDK_DOMAIN  REACT_APP_AGORA_APP_TOKEN_DOMAIN=$REACT_APP_AGORA_APP_TOKEN_DOMAIN  yarn ci:build:web
echo "-----build finished------"
